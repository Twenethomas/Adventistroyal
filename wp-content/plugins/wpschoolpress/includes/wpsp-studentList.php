  ...
  <div class="wpsp-card-head">
    ...
    <div class="wpsp-right wpsp-import-export">
      <div class="wpsp-btn-lists" <?php echo esc_html($prodisable);?> title="<?php echo esc_attr($protitle);?>">
        ...
        <div class="wpsp-btn-list" <?php if($proversion['status'] != "1") {?> wpsp-tooltip="<?php echo esc_attr($protitle);?>" <?php } ?>>
          <button id="ImportStudent" class="wpsp-btn wpsp-dark-btn wpsp-popclick impt" <?php echo esc_html($prodisable);?> title="<?php //echo esc_attr($protitle);?>" data-pop="ImportModal"><i class="fa fa-upload"></i> <?php echo esc_html("Import","wpschoolpress");?> </button>
        </div>
        <?php }?>
        <div class="wpsp-btn-list" <?php if($proversion['status'] != "1") {?> wpsp-tooltip="<?php echo esc_attr($protitle);?>" <?php } ?>>
          <div class="wpsp-dropdownmain wpsp-button-group">
            <button type="button" class="wpsp-btn print" id="ExportStudents" <?php echo esc_html($prodisable);?> title="<?php //echo esc_attr($protitle);?>"><i class="fa fa-download"></i> <?php esc_html_e( 'Export', 'wpschoolpress'); ?> </button>
      ...
      <table id="student_table" class="wpsp-table" cellspacing="0" width="100%" style="width:100%">
        <thead>
          <tr>
            ...
            <th><?php echo esc_html__('Roll No.','wpschoolpress');?></th>
            <th><?php echo esc_html__('Full Name','wpschoolpress');?></th>
            <th><?php echo esc_html__('Parent','wpschoolpress');?></th>
            <th><?php echo esc_html__('Street Address','wpschoolpress');?></th>
            <?php  if($propayment =='installed'){?>
            <th><?php echo esc_html__('Payment Status','wpschoolpress');?></th>
            <?php } ?>
            <?php  if($proversion1['status']){?>
            <th><?php echo esc_html__('Class Status','wpschoolpress');?></th>
            <?php } ?>
            <th><?php echo esc_html__('Phone','wpschoolpress');?></th>
            <th align="center" class="nosort"><?php echo esc_html__('Action','wpschoolpress');?></th>
          </tr>
        </thead>
        <tbody>
          <?php
